...
describe("Add Disposition in Settings - Optimized", () => {
    beforeEach(() => {
        cy.visit("https://uat.mloflo.com/"); // Navigate to application URL
    });

    it("Adds a new disposition in settings", () => {
        ...
        cy.get('.page-loader > .content-box > .d-flex > .d-flex > .cstm-dark-text')
          .click(); // Click on Add Disposition button
        
        cy.get('form > #modalBody > .form-row > .form-group > .champ-form__cm-input')
          .should('be.visible')
          .type(faker.person.firstName()); // Enter Disposition Name
